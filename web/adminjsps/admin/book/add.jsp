   ...
   <form action="<c:url value='/admin/AdminAddBookServlet'/>" enctype="multipart/form-data" method="post" id="form">
    <div>
	    <ul>
	    	...
	    	<li>定价：   <input id="price" type="text" name="price" style="width:50px;"/></li>
	    	<li>当前价：<input id="currPrice" type="text" name="currPrice"  style="width:50px;"/>
		...
		<table>
			...
			<tr>
				<td>
					...
					<c:forEach var="oneLevel" items="${categories}">
						<option value="${oneLevel.cid}">${oneLevel.cname}</option>
					</c:forEach>
					</select>
				</td>
				<td>
