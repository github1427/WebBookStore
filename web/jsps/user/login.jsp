                ...
                <div>
                    <form target="_top" action="<c:url value='/UserServlet'/>" method="post" id="loginForm">
                        ...
                        <table>
                            <tr>
                                <td width="50"></td>
                                <td><label class="error" id="msg">${requestScope.loginError}</label></td>
                            </tr>
                            <tr>
                                <td width="50">用户名</td>
                            ...
                            <tr>
                                <td height="20">&nbsp;</td>
                                <td><label id="loginnameError" class="error">${errors.loginpass}</label></td>
                            </tr>
                            <tr>
                                <td>密　码</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img id="vCode" src="/goods/verifyCode"/>
